function ThanosQuoteCommand(msg, args, notice, Discord, AyameClient, Db, EmbedTemplate) {
  const quotes = [
  "The end is near.",
  ...
  msg.channel.send(`${notice}${quotes[Math.floor(Math.random() * quotes.length)]}`)
  
}
module.exports = ThanosQuoteCommand;